...
Declares [**Tryll::TryllClient**](class_tryll_1_1_tryll_client.md), the primary client class, and [**Tryll::ConnectedSession**](class_tryll_1_1_connected_session.md), the recommended one-call entry point for local-server deployments. The session-level types — [**Tryll::Client::ModelStatus**](namespace_tryll_1_1_client.md#enum-modelstatus), [**Tryll::Client::ModelInfo**](struct_tryll_1_1_client_1_1_model_info.md), [**Tryll::Client::DownloadProgressCallback**](namespace_tryll_1_1_client.md#typedef-downloadprogresscallback) — live in the `Tryll::Client` namespace.
