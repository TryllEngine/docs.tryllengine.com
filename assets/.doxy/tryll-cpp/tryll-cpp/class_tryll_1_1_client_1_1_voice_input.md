...
# Class Tryll::Client::VoiceInput



[**ClassList**](annotated.md) **>** [**Tryll**](namespace_tryll.md) **>** [**Client**](namespace_tryll_1_1_client.md) **>** [**VoiceInput**](class_tryll_1_1_client_1_1_voice_input.md)
...
| Type | Name |
| ---: | :--- |
| typedef std::function&lt; void(const [**TranscriptUpdate**](struct_tryll_1_1_client_1_1_transcript_update.md) &)&gt; | [**TranscriptCallback**](#typedef-transcriptcallback)  <br> |
...
| Type | Name |
| ---: | :--- |
|  void | [**BeginUtterance**](#function-beginutterance) ([**UtteranceOptions**](struct_tryll_1_1_client_1_1_utterance_options.md) opts={}, std::chrono::milliseconds timeout=std::chrono::seconds{10}) <br> |
|  std::future&lt; void &gt; | [**BeginUtteranceAsync**](#function-beginutteranceasync) ([**UtteranceOptions**](struct_tryll_1_1_client_1_1_utterance_options.md) opts={}) <br>_Open a new utterance. Rejects if one is already active (throws_ [_**TryllError**_](class_tryll_1_1_client_1_1_tryll_error.md) _)._ |
...
Move-only handle to a server-side [**VoiceInput**](class_tryll_1_1_client_1_1_voice_input.md) session.


Obtained via [**TryllClient::CreateVoiceInput**](class_tryll_1_1_client_1_1_tryll_client.md#function-createvoiceinput) or CreateVoiceInputAsync.
...
```C++
using Tryll::Client::VoiceInput::TranscriptCallback = std::function<void(const TranscriptUpdate&)>;
```
...
```C++
void Tryll::Client::VoiceInput::BeginUtterance (
...
_Open a new utterance. Rejects if one is already active (throws_ [_**TryllError**_](class_tryll_1_1_client_1_1_tryll_error.md) _)._
```C++
std::future< void > Tryll::Client::VoiceInput::BeginUtteranceAsync (
    UtteranceOptions opts={}
) 
```
...
```C++
void Tryll::Client::VoiceInput::CancelUtterance (
    std::chrono::milliseconds timeout=std::chrono::seconds{10}
) 
```
...
```C++
std::future< void > Tryll::Client::VoiceInput::CancelUtteranceAsync () 
```
...
```C++
void Tryll::Client::VoiceInput::EndUtterance (
...
```C++
std::future< void > Tryll::Client::VoiceInput::EndUtteranceAsync () 
```



Commit the utterance (push-to-talk release). The engine drains pending audio, decodes, and delivers the final [**TranscriptUpdate**](struct_tryll_1_1_client_1_1_transcript_update.md). 
...
```C++
std::uint64_t Tryll::Client::VoiceInput::GetVoiceInputId () noexcept const
```
...
```C++
bool Tryll::Client::VoiceInput::IsUtteranceActive () noexcept const
```
...
```C++
void Tryll::Client::VoiceInput::SendAudioBuffer (
...
```C++
void Tryll::Client::VoiceInput::SetOnTranscriptUpdate (
...
```C++
Tryll::Client::VoiceInput::VoiceInput (
    const VoiceInput &
) = delete
```
...
```C++
VoiceInput & Tryll::Client::VoiceInput::operator= (
    const VoiceInput &
) = delete
```
...
```C++
class Tryll::Client::VoiceInput::TryllClientImpl (
