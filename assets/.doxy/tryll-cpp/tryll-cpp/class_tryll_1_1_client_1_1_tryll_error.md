...
# Class Tryll::Client::TryllError



[**ClassList**](annotated.md) **>** [**Tryll**](namespace_tryll.md) **>** [**Client**](namespace_tryll_1_1_client.md) **>** [**TryllError**](class_tryll_1_1_client_1_1_tryll_error.md)



_Exception thrown by_ [_**TryllClient**_](class_tryll_1_1_client_1_1_tryll_client.md) _and_[_**AgentProxy**_](class_tryll_1_1_client_1_1_agent_proxy.md) _on server errors or disconnects._[More...](#detailed-description)
...
```C++
inline std::uint32_t Tryll::Client::TryllError::GetCode () noexcept const
```
...
```C++
inline const std::string & Tryll::Client::TryllError::GetMessage () noexcept const
```
...
```C++
inline explicit Tryll::Client::TryllError::TryllError (
    std::uint32_t code,
    std::string message
) 
```
